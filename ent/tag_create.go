...
func (tc *TagCreate) check() error {
	...
	if _, ok := tc.mutation.Rank(); !ok {
		return &ValidationError{Name: "rank", err: errors.New(`ent: missing required field "Tag.rank"`)}
	}
	return nil
}
