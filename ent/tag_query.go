...
func (_q *TagQuery) QueryServers() *FavoriteServerQuery {
	query := (&FavoriteServerClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithServers(opts ...func(*FavoriteServerQuery)) *TagQuery {
	query := (&FavoriteServerClient{config: _q.config}).Query()
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withServers; query != nil {
...
func (_q *TagQuery) loadServers(ctx context.Context, query *FavoriteServerQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *FavoriteServer)) error {
