...
type TagEdges struct {
	...
	Servers []*FavoriteServer `json:"servers,omitempty"`
...
func (e TagEdges) ServersOrErr() ([]*FavoriteServer, error) {
	if e.loadedTypes[0] {
...
func (_m *Tag) QueryServers() *FavoriteServerQuery {
	return NewTagClient(_m.config).QueryServers(_m)
}
